...
lang: fr
layout: doc
permalink: /fr/doc/anti-evil-maid/
redirect_from:
- /fr/doc/anti-evil-maid/
- /fr/doc/AntiEvilMaid/
- /fr/wiki/AntiEvilMaid/
ref: 27
...
Dans Dom0, installer anti-evil-maid :
...
[Qubes security guidelines](/fr/doc/security-guidelines/) dictate that USB devices should never be attached directly to dom0, since this can result in the entire system being compromised.
...
(In either case, users can--and should--secure dom0 against further USB-related attacks through the use of a [USBVM](/fr/doc/security-guidelines/#creating-and-using-a-usbvm).)

Pour plus d'informations, veuillez consulter [ce fil de discussion (en anglais)](https://groups.google.com/d/msg/qubes-devel/EBc4to5IBdg/n1hfsHSfbqsJ).
