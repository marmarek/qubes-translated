...
El árbol resultante estará en kernel-\<VERSION\>/linux-\<VERSION\>:
...
Ahora cambie la configuración. Por ejemplo, en kernel-3.4.18/linux-3.4.18:

~~~
make menuconfig
~~~

Copie la configuración modificada de vuelta al árbol del kernel:
...
PENDIENTE: Describir la dinámica de trabajo para parchear el código, debajo tiene algunas notas al azar, no funciona bien
...
PENDIENTE: ¿Este paso es genérico para todos los subsistemas?
...
PENDIENTE: Editar este script para que sea más genérico
...
PENDIENTE: Hacerlo más genérico
