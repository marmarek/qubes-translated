...
lang: es
layout: doc
permalink: /es/doc/anti-evil-maid/
redirect_from:
- /es/doc/anti-evil-maid/
- /es/doc/AntiEvilMaid/
- /es/wiki/AntiEvilMaid/
ref: 27
...
[Debate](https://groups.google.com/d/msg/qubes-users/sEmZfOZqYXM/j5rHeex1BAAJ)

Installing
----------

Instalar anti-evil-maid en el dom0:
...
[Qubes security guidelines](/es/doc/security-guidelines/) dictate that USB devices should never be attached directly to dom0, since this can result in the entire system being compromised.
...
(In either case, users can--and should--secure dom0 against further USB-related attacks through the use of a [USBVM](/es/doc/security-guidelines/#creating-and-using-a-usbvm).)

Para más información, por favor, vea [este hilo de debate](https://groups.google.com/d/msg/qubes-devel/EBc4to5IBdg/n1hfsHSfbqsJ).
