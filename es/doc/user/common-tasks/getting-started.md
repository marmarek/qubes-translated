...
redirect_from:
- /es/doc/getting-started/
- /es/doc/getting-started/
- /es/doc/GettingStarted/
- /es/wiki/GettingStarted/
ref: 69
title: Comenzar
translated: 'yes'
---

<a name="already-installed"></a>After [installing Qubes](/es/doc/installation-guide/), let's cover some basic concepts.
You might also like to refer to the [Glossary](/es/doc/glossary/).
...
In particular, [you should never run user applications in dom0](/es/doc/security-guidelines/#dom0-precautions). 
...
Various command line tools are described as part of this guide, and the whole reference can be found [here](/es/doc/tools/).
...
You'll also be able to easily copy any files you need to the newly created qube, as explained [here](/es/doc/copying-files/).
...
A full list is available in the [Common Tasks](/es/doc/#common-tasks) section of the documentation.

 * [Copying and Pasting Text Between Domains](/es/doc/copy-paste/)
 * [Copying and Moving Files Between Domains](/es/doc/copying-files/)
 * [Copying from (and to) dom0](/es/doc/copy-from-dom0/)
 * [Updating Software in dom0](/es/doc/software-update-dom0/)
 * [Updating and Installing Software in VMs](/es/doc/software-update-vm/)
 * [Backup, Restoration, and Migration](/es/doc/backup-restore/)
 * [Using DisposableVMs](/es/doc/disposablevm/)
 * [Using and Managing USB Devices](/es/doc/usb/)
...
More details can be found [here](/es/doc/full-screen-mode/).

<div class="row">
  <div class="col-lg-4 col-md-4">
    <h2>Compatible Hardware</h2>
    <p>Ready to install Qubes? Make sure your hardware is compatible, as Qubes cannot run on every type of computer. Also, check out <a href="/es/doc/certified-laptops/">Qubes-certified Laptops</a>.</p>
    <a href="/es/hcl/" class="btn btn-primary">
  ...
  <div class="col-lg-4 col-md-4">
    ...
    <a href="/es/downloads/" class="btn btn-primary">
      <i class="fa fa-download"></i> Downloads
    </a>
  </div>
  <div class="col-lg-4 col-md-4">
    <h2>Documentation</h2>
    <p>Peruse our extensive library of documentation for users and developers of Qubes. You can even help us <a href="/es/doc/doc-guidelines/">improve</a> it!</p>
    <a href="/es/doc/" class="btn btn-primary">
