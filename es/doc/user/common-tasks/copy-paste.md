...
Observe que el portapapeles global se borrará tras el paso 3, para evitar el filtrado desintencionado a otro dominio si el usuario pulsa accidentalmente Ctrl+Shift+V más tarde.
...
Y [este mensaje](https://groups.google.com/group/qubes-devel/msg/48b4b532cee06e01) de qubes-devel.

Copy/Paste between dom0 and other domains
-----------------------------------------

See ["Copying from (and to) dom0"](/es/doc/copy-from-dom0/).
...
Los atajos de teclado de copiado/pegado pueden configurarse en:

~~~
/etc/qubes/guid.conf
~~~

Las VMs han de reiniciarse para que los cambios en `/etc/qubes/guid.conf` tengan efecto.


[RPC policy]: /es/doc/rpc-policy/