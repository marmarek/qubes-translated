...
lang: es
layout: doc
permalink: /es/doc/optical-discs/
redirect_from:
- /es/doc/recording-optical-discs/
- /es/doc/recording-optical-discs/
ref: 72
title: Optical Discs
translated: 'yes'
...
Currently, the only options for reading and recording optical discs (e.g., CDs, DVDs, BRDs) in Qubes are:
 ...
 3. Use a SATA optical drive attached to dom0.
    (**Caution:** This option is [potentially dangerous](/es/doc/security-guidelines/#dom0-precautions).)

To access an optical disc via USB follow the [typical procedure for attaching a USB device](/es/doc/usb-devices/#with-the-command-line-tool), then check with the **Qubes Devices** widget to see what device in the target qube the USB optical drive was attached to.
