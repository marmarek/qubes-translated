 ...
 * The official name is `Qubes OS` (note the capitalization and spacing).
   Sin embargo, en conversaciones informales a menudo se acorta a `Qubes`, y en contextos técnicos donde los espacios no están permitidos, (p. ej., nombres de usuario), los espacios pueden ser omitidos, como en `QubesOS`.
...
Qube
----
Es un término afable para una [VM](#vm) en Qubes OS.
...
This domain may include your email qube and your [Split GPG](/es/doc/split-gpg) qube. 
...
TemplateVM
----------
[Template Virtual Machine](/es/doc/templates/).
...
Standalone(VM)
--------------
[Standalone (Virtual Machine)](/es/doc/standalone-and-hvm/).
...
DisposableVM
------------
[Disposable Virtual Machine](/es/doc/disposablevm/).
 ...
 * **Dedicated** DisposableVM Templates are intended neither for installing nor running software.
   Rather, they are intended for *customizing* or *configuring* software that has already been installed on the TemplateVM on which the DisposableVM Template is based (see [DisposableVM Customization](/es/doc/disposablevm-customization/).
...
HVM
---
[Hardware-assisted Virtual Machine](/es/doc/standalone-and-hvm/).
